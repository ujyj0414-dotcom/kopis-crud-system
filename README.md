  ...
  <tbody>
    <tr>
      <td align="center" valign="top" width="33.3%">
        <a href="https://github.com/teomichaelpark-glitch">
...
<ul>
  ...
  <li>'게시판' 탭: BoardLibraryPage 컴포넌트 <b>조건부 렌더링</b> 및 개별 게시판 <b>'찜하기'</b> 기능 구현</li>
</ul>
<hr>
<b>[대표 스크린샷]</b><br>
...
이 상세 페이지에서 <b>CRUD</b> 4가지 기능이 모두 구현됩니다.<br>
`localStorage`에서 목록을 <b>조회(Read)</b>하고, 하단의 입력폼으로 항목을 <b>생성(Create)</b>하며, 체크박스로 상태를 <b>수정(Update)</b>하고, 아이콘으로 <b>삭제(Delete)</b>할 수 있습니다.
<br>
...
프로젝트의 **모든 페이지**는 CSS Grid Layout과 Media Query를 활용하여 PC, 태블릿, 모바일 등 다양한 디바이스 환경에 대응합니다. (아래는 '공연' 탭의 예시 화면입니다.)
